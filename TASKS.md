...
order. The asset pipeline is done (T-4.02, `pnpm gen:assets`), so budgets
(T-4.03) and the loader (T-4.05) are open, beside the level format (T-4.09), mission sequence (T-4.14), reconnect

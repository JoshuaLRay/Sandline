...
pipeline, `pnpm gen:audio`), is done; T-2.45 (playback and the sound board) and
T-2.48 (the voice pipeline) are open. The owner can record the voice lines any time, from

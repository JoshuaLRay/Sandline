...
| `?codesoldier` | the squad in the old code-built soldier instead of the detailed desert-camouflage one (T-4.08), for comparing; `?greybox` is the rig's grey-box fixture |

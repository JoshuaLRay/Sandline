...
- T-2.15 — Revive: hold E within 1.5 m of a downed teammate for 3 s to stand them up at 40% health; server-side progress that letting go, stepping away or going down resets; one reviver at a time; progress and the reviver's seat on the wire (protocol v8) so both HUDs show it; the snapshot now carries each soldier's seat.

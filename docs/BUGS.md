...
| B-06 | Input | Holding Ctrl to crouch, then pressing another key, fires a browser shortcut (find, bookmark, print, etc.) instead of reaching the game — only Space was preventDefault'd. | FIXED | — |
